...
_dino_cfg = _get_plugin_config("dino")
_input_size = _dino_cfg.get("input_size", 518)
_patch_size = _dino_cfg.get("patch_size", 14)
PATCH_GRID = _input_size // _patch_size

CHIP_SIZE_PX = _get_config().get("chip_size_px", 448)
...
def cam_to_heatmap_png(cam, size=CHIP_SIZE_PX):
